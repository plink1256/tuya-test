...
class TuyaFanEntity(TuyaEntity, FanEntity):
    ...
    def __init__(self, device: TuyaDevice, device_manager: TuyaDeviceManager) -> None:
        ...
        if DPCode.FAN_SPEED_ENUM in self.device.function:
            self.ha_preset_modes = json.loads(
                self.device.function[DPCode.FAN_SPEED_ENUM].values
            ).get("range", [])
    ...
    def set_preset_mode(self, preset_mode: str) -> None:
        ...
        self._send_command([{"code": DPCode.FAN_SPEED_ENUM, "value": preset_mode}])
    ...
    def preset_mode(self) -> str:
        ...
        return self.device.status[DPCode.FAN_SPEED_ENUM]
